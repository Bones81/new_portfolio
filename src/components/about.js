  ...
  return (
    <section id="about">
      ...
      <article id="bio-text">
        ...
        <p>Enter Code. While I had dipped my toe into coding waters many times, I didn't decide to leap off the high board until January of 2022, when I enrolled in a General Assembly Software Engineering Immersive. There I solidified a set of full stack skills and grew in confidence as a developer. General Assembly validated my growing skills by immediately hiring me as an Instructional Associate for the April 2022 version of the same course.</p>
        ...
        <p>I hope to achieve meaningful change through my code. Whether that means making your life or work easier, more productive, or more fun, my work can serve your organization's needs.</p>
      </article>
    </section>
  )
}
