  ...
  return (
    <section id="about">
      ...
      <article id="bio-text">
        ...
        <p>I hope to achieve meaningful change through my code. Whether that means making your life or work easier, more productive, or more fun, my work can help you achieve your goals.</p>
      </article>
    </section>
  )
}
